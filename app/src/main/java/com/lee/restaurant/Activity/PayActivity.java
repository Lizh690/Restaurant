...
public class PayActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        payWX = (RelativeLayout) findViewById(R.id.pay_method_wx);
        payAli = (RelativeLayout) findViewById(R.id.pay_method_ali);
        payIVAli = (ImageView) findViewById(R.id.pay_iv_ali);
        payIVWX = (ImageView) findViewById(R.id.pay_iv_wx);
        payAliChecked = (ImageView) findViewById(R.id.pay_ali_checked);
        payWXChecked = (ImageView) findViewById(R.id.pay_wx_checked);
        payButton = (Button) findViewById(R.id.pay_button);
        tvTotalPrice = (TextView) findViewById(R.id.pay_total);
    ...
    private void pay(boolean aliOrWx){
        if (aliOrWx){
            if (!checkPackageInstalled("com.eg.android.AlipayGphone")){
                android.app.AlertDialog.Builder dialog = new android.app.AlertDialog.Builder(PayActivity.this);
...
//                    installBmobPayPlugin("bp.db");
                    ...
                    Toast.makeText(PayActivity.this, "支付中断! code = " + code + " reason = " + reason, Toast.LENGTH_SHORT)
                            .show();
                }

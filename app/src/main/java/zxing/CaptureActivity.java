...
import zxing.decode.BitmapDecoder;
...
//				Toast.LENGTH_SHORT).show();
		...
		intent.putExtra("QRResult",ResultParser.parseResult(rawResult).toString());

		int requestCode = getIntent().getIntExtra("requestCode",3);
		switch (requestCode){
			case 1:
				setResult(1,intent);
				break;
